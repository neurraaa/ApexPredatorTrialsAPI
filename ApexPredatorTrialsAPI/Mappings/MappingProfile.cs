    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<GameEventSchedule, GameEventScheduleDto>()
                ...
                .ForMember(dest => dest.WinnerPlayerId, opt => opt.MapFrom(src => src.Match != null && src.Match.MatchResults != null ? src.Match.MatchResults.WinnerId : (int?)null))
                .ForMember(dest => dest.MapId, opt => opt.MapFrom(src => src.Match != null ? (int?)src.Match.MapId : null))
                .ForMember(dest => dest.MapName, opt => opt.MapFrom(src => src.Match != null ? src.Match.Map.Name : null));
